...
from config import (
    HEIGHTMAP_PNG, BUILDINGS_GEOJSON, LANDUSE_GEOJSON, LANDUSE_TEXTURE_PNG,
    ROADS_GEOJSON, TREES_GEOJSON, FURNITURE_GEOJSON, FACADE_ATLAS_PNG, GODOT_DATA_DIR,
)
...
_EXPORTS = [
    ...
    (FURNITURE_GEOJSON,                 GODOT_DATA_DIR / "furniture.geojson"),
    (FACADE_ATLAS_PNG,                  GODOT_DATA_DIR / "facade_atlas.png"),
]
